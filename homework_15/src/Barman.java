...
public class Barman extends Employee {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Waiter) {
            Barman barmen = (Barman) obj;
            if (this.name != null && barmen.name != null) {
                boolean equals = barmen.name.equals(((Barman) obj).name);
                if (equals) {
                    equals = barmen.years == ((Barman) obj).years;
                    if (equals) {
                        return barmen.bailiwickCocktail.equals(((Barman) obj).bailiwickCocktail);
                    }
                }
            }
        }
